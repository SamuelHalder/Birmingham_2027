...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_verify()) {
        ...
        if ($name === '' || $email === '') {
            ...
            User::update($id, $name, $email, $role, $isActive);
    ...
    <div class="card-body">
        ...
        <form method="post" novalidate class="flex flex-col gap-3">
            ...
            <label class="form-control w-full">
                ...
                <input type="password" name="password" class="input input-bordered w-full" minlength="8" placeholder="Leave blank to keep current password">
            </label>
            <label class="form-control w-full">
            ...
            <label class="label cursor-pointer justify-start gap-3">
                <input type="checkbox" name="is_active" class="checkbox" <?= $isActive ? 'checked' : '' ?>>
