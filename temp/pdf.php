...
$date = $_GET['date'] ?? 'Date';
$inviteeName = $_GET['name'] ?? '[Full Name of Invitee]';
$passportCountry = $_GET['country'] ?? 'Country Of Passport';
$passportNumber = $_GET['passport'] ?? 'Passport Number';
$dateOfBirth = $_GET['dob'] ?? 'Date of Birth';
$dateOfIssue = $_GET['issue'] ?? 'Date of Issue';
$dateOfExpiry = $_GET['expiry'] ?? 'Date of Expiry';
$homeAddress = $_GET['address'] ?? '[Full Address]';

// ============================================================
// IMAGE URLS
// ============================================================
// Upload these images to your server and put the PUBLIC HTTPS
// URLs here.
//
// Example:
// https://yourdomain.com/assets/logo.png
// https://yourdomain.com/assets/signature.png
// https://yourdomain.com/assets/footer.png
// ============================================================

$logoUrl = 'https://2027.lcadooarsmountain.org/assets/logo.png';
$signatureUrl = 'https://2027.lcadooarsmountain.org/assets/sign1.png';
$footerUrl = 'https://2027.lcadooarsmountain.org/assets/footer.png';
...
$filename = 'Visa Letter - ' . $safeName . '.pdf';
